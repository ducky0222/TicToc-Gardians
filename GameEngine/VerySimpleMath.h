//-------------------------------------------------------------------------------------
// Very X implimentation of By AngrybirdTeam
// this is very simple
//-------------------------------------------------------------------------------------
...
namespace Very
{
	namespace SimpleMath
	{
		...
		{
			GENERATE_CLASS_TYPE_INFO(Vector2)
				PROPERTY(x)
				PROPERTY(y)
		...
		{
			GENERATE_CLASS_TYPE_INFO(Vector4)
				PROPERTY(x)
				PROPERTY(y)
				PROPERTY(z)
				PROPERTY(w)
		...
		{
			GENERATE_CLASS_TYPE_INFO(Matrix)
			PROPERTY(_11)
			PROPERTY(_12)
			PROPERTY(_13)
			PROPERTY(_14)
		...
		{
			GENERATE_CLASS_TYPE_INFO(Plane)
			PROPERTY(x)
			PROPERTY(y)
			PROPERTY(z)
			PROPERTY(w)
		...
		struct Boolean3
		{
			GENERATE_CLASS_TYPE_INFO(Boolean3)
			PROPERTY(x)
			PROPERTY(y)
			PROPERTY(z)
			NLOHMANN_DEFINE_TYPE_INTRUSIVE(Boolean3, x, y, z)
		...
		{
			GENERATE_CLASS_TYPE_INFO(Color)
			PROPERTY(x)
			PROPERTY(y)
			PROPERTY(z)
			PROPERTY(w)
...
namespace std
{
	...
	template<> struct less<Very::SimpleMath::Rectangle>
	{
		bool operator()(const Very::SimpleMath::Rectangle& r1, const Very::SimpleMath::Rectangle& r2) const noexcept
		{
			return ((r1.x < r2.x)
				|| ((r1.x == r2.x) && (r1.y < r2.y))
	...
	template<> struct less<Very::SimpleMath::Vector2>
	{
		bool operator()(const Very::SimpleMath::Vector2& V1, const Very::SimpleMath::Vector2& V2) const noexcept
		{
			return ((V1.x < V2.x) || ((V1.x == V2.x) && (V1.y < V2.y)));
		}
	};

	template<> struct less<Very::SimpleMath::Vector3>
	{
		bool operator()(const Very::SimpleMath::Vector3& V1, const Very::SimpleMath::Vector3& V2) const noexcept
		{
			return ((V1.x < V2.x)
				|| ((V1.x == V2.x) && (V1.y < V2.y))
	...
	template<> struct less<Very::SimpleMath::Vector4>
	{
		bool operator()(const Very::SimpleMath::Vector4& V1, const Very::SimpleMath::Vector4& V2) const noexcept
		{
			return ((V1.x < V2.x)
				|| ((V1.x == V2.x) && (V1.y < V2.y))
				|| ((V1.x == V2.x) && (V1.y == V2.y) && (V1.z < V2.z))
	...
	template<> struct less<Very::SimpleMath::Matrix>
	{
		bool operator()(const Very::SimpleMath::Matrix& M1, const Very::SimpleMath::Matrix& M2) const noexcept
		{
	...
	template<> struct less<Very::SimpleMath::Plane>
	{
		bool operator()(const Very::SimpleMath::Plane& P1, const Very::SimpleMath::Plane& P2) const noexcept
		{
			return ((P1.x < P2.x)
				|| ((P1.x == P2.x) && (P1.y < P2.y))
	...
	template<> struct less<Very::SimpleMath::Quaternion>
	{
		bool operator()(const Very::SimpleMath::Quaternion& Q1, const Very::SimpleMath::Quaternion& Q2) const noexcept
		{
			return ((Q1.x < Q2.x)
				|| ((Q1.x == Q2.x) && (Q1.y < Q2.y))
	...
	template<> struct less<Very::SimpleMath::Color>
	{
		bool operator()(const Very::SimpleMath::Color& C1, const Very::SimpleMath::Color& C2) const noexcept
		{
			return ((C1.x < C2.x)
				|| ((C1.x == C2.x) && (C1.y < C2.y))
	...
	template<> struct less<Very::SimpleMath::Ray>
	{
		bool operator()(const Very::SimpleMath::Ray& R1, const Very::SimpleMath::Ray& R2) const noexcept
		{
	...
	template<> struct less<Very::SimpleMath::Viewport>
	{
		bool operator()(const Very::SimpleMath::Viewport& vp1, const Very::SimpleMath::Viewport& vp2) const noexcept
		{
