...
public:
	...
	static Vector3 GetCamPos(const Matrix& view)
	{
		Vector3 camPos =
			-view._41 * Vector3(view._11, view._21, view._31) +
			-view._42 * Vector3(view._12, view._22, view._32) +
			-view._43 * Vector3(view._13, view._23, view._33);
	...
	inline void SetLensOrtho(float viewWidth, float viewHeight, float zn, float zf);
